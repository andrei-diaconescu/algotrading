...
def test_peek_and_drawdown():
    ...
    candle.low = 99.8
    candle.high = 100
    assert_peek_and_drawdown_prices_after_updating_trade_with_candle(99.8, 100)

    candle.low = 99.3
    candle.high = 99.7
    assert_peek_and_drawdown_prices_after_updating_trade_with_candle(99.3, 100)

    candle.low = 99.1
    candle.high = 100.9
    assert_peek_and_drawdown_prices_after_updating_trade_with_candle(99.1, 100.9)
